...
# num_esperado = 3
# nem_obtido = 2
# assert num_esperado != nem_obtido, f"Esperado '{num_esperado}' não é maior que o numero atual '{nem_obtido}'."
...
# exemplo no "test_comandos_interacao_com_elementos.py"
